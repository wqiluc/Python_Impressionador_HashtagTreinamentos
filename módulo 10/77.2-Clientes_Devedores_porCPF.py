# ============================================================
# 📌 ITEM 2 — CLIENTES INADIMPLENTES
# ============================================================
#
# 🎯 O que esse código deve fazer?
# Descobrir quais clientes estão inadimplentes e separar
# esses clientes para o setor de cobrança 💸
#
# ------------------------------------------------------------
# 📥 Como os dados chegam?
# A função recebe uma LISTA de clientes.
#
# Cada cliente vem assim:
# (cpf, valor_devido, dias_em_atraso)
#
# Exemplo:
# ("12345678900", 1500, 25)
#
# Ou seja:
# - cpf → identifica o cliente 🪪
# - valor_devido → quanto ele está devendo 💰
# - dias_em_atraso → há quantos dias a dívida venceu ⏳
#
# ------------------------------------------------------------
# 📤 O que a função deve devolver?
# Uma LISTA somente com os CPFs dos clientes inadimplentes ⚠️
#
# Não precisa retornar nome, valor nem dias.
# Apenas o CPF já resolve o problema ✅
#
# ------------------------------------------------------------
# 🤔 Quando um cliente é inadimplente?
#
# O cliente SÓ é inadimplente se:
# ✔ Deve MAIS de R$ 1.000
# ✔ Está em atraso por MAIS de 20 dias
#
# 👉 As duas regras precisam ser verdadeiras ao mesmo tempo
#
# ------------------------------------------------------------
# ❌ Exemplos fáceis de entender:
#
# - Deve R$ 2.000, mas só atrasou 10 dias
#   ❌ NÃO é inadimplente (o atraso é pequeno)
#
# - Deve R$ 500, mas está atrasado há 40 dias
#   ❌ NÃO é inadimplente (o valor é baixo)
#
# - Deve R$ 1.500 e está atrasado há 30 dias
#   ✅ É inadimplente (valor alto + muito atraso)
#
# ------------------------------------------------------------
# 🧠 Resumo rápido:
# 💰 valor > 1000
# ⏳ dias > 20
# 📤 retorna apenas o CPF
# ============================================================
...
def clientes_devedores_por_cpf():
    for indice_devedores_por_cpf, devedores_por_cpf in enumerate(clientes_devedores):
        if (devedores_por_cpf[1])>1000 and (devedores_por_cpf[2])>20:
            print(f"\n {Negrito}Cliente de número {indice_devedores_por_cpf+1}: CPF {indice_devedores_por_cpf+1}: '{devedores_por_cpf[0]}' - Valor que deve:{Reset} {Verde}R${Reset}{Negrito}{devedores_por_cpf[1]}{Reset} - {Negrito}Há quantos dias deve:{Reset} {Amarelo}{devedores_por_cpf[2]} Dias {Reset}")

case_empresa2 = clientes_devedores_por_cpf()